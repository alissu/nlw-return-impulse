...
export function FeedbackContentStep({
  ...
  async function handleSubmitFeedback(event: FormEvent) {
    // para evitar que ao submitar, recarregue a página.
      ...
      <form onSubmit={handleSubmitFeedback} className='my-4 w-full'>
        ...
        <footer className='flex gap-2 mt-2'>
          ...
          <button
            ...
            className={
              `p-2 bg-brand-500 rounded-md border-transparent flex-1 flex justify-center items-center text-sm hover:bg-brand-300
